      ...
      {	
        try
        {
          ...
          NodeUtils::Async::RunCallbackOnMain(asyncToken, [result](NodeUtils::InvokeCallbackDelegate invokeCallback) {
            ...
            TryCatch tryCatch;
            Local<Value> error; 
            Local<Value> arg1 = WrapJumpList(result);
      ...
      {	
        try
        {
          ...
          NodeUtils::Async::RunCallbackOnMain(asyncToken, [result](NodeUtils::InvokeCallbackDelegate invokeCallback) {
            ...
            TryCatch tryCatch;
            Local<Value> error; 
            Local<Value> arg1 = NodeRT::Collections::VectorViewWrapper<::Windows::UI::StartScreen::SecondaryTile^>::CreateVectorViewWrapper(result, 
          ...
          registrationToken = wrapper->_instance->VisualElementsRequested::add(
            ...
            [callbackObjPtr](::Windows::UI::StartScreen::SecondaryTile^ arg0, ::Windows::UI::StartScreen::VisualElementsRequestedEventArgs^ arg1) {
              NodeUtils::Async::RunOnMain([callbackObjPtr , arg0, arg1]() {
                ...
                Local<Value> wrappedArg0 = WrapSecondaryTile(arg0);
                Local<Value> wrappedArg1 = WrapVisualElementsRequestedEventArgs(arg1);
