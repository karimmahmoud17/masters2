...
var npmScope = 'nodert-win10-au';

try {
  // this little trick makes node.js Tools for VS load intellisense for the module
  if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_ApplicationModel.d.js)'))) {
    module.exports = require('./NodeRT_Windows_ApplicationModel.d.js');
  }
...
var externalReferencedNamespaces = ['Windows.Foundation', 'Windows.Storage.Streams', 'Windows.System', 'Windows.Storage', 'Windows.ApplicationModel.Core'];
